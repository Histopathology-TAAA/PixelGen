"""
Main entry point for Image-to-Image virtual staining training.
Uses I2ILightningModel and I2IDataModule.

Usage:
    python main_i2i.py fit --config configs_i2i/mist_ki67.yaml
"""
import os
import torch
import time
...
from src.lightning_data import I2IDataModule
from src.lightning_model_i2i import I2ILightningModel
